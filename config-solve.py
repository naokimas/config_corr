...
#   r: learning rate
#   corr_preserve = 1 if the node strength in terms of the Pearson corr should be preserved.
#                          = 0 if the node strength in terms of the covariance should be preserved. Should be set to 0, and one should feed a correlation matrix as C
#
# Output
